...
<head>
    ...
    <title>Register University &rarr; SLMS</title>
                                ...
                                <div class="header-wrap">
                                        ...
                                        <nav id="menu" class="menu menu--primary">
                                            <ul id="menu-primary" class="menu__container sm sm-simple">
                                                ...
                                                <li id="menu-item-20" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-20 level-1">
                                                    <a href="#">
                                                        <div class="menu-item-wrap"><span class="menu-item-title">Enroll</span><span class="toggle-sub-menu"> </span></div>
                                                    </a>
                                                    <ul class="sub-menu children simple-menu">
                                                        ...
                                                        <li id="menu-item-1851" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1851">
                                                            <a href="../includes/add_university.php">
                                                        ...
                                                        <li id="menu-item-426" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-426">
                                                            <a href="../includes/university.php">
                                                                <div class="menu-item-wrap"><span class="menu-item-title">Register University</span></div>
                                                            </a>
                                                        </li>
                                                        <!-- <li id="menu-item-425" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-425">
                                                            <a href="../includes/add_student.php">
                                                                <div class="menu-item-wrap"><span class="menu-item-title">Add Student</span></div>
                                                            </a>
                                                        </li>
                                                        <li id="menu-item-425" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-425">
                                                            <a href="../includes/view_student.php">
                                                                <div class="menu-item-wrap"><span class="menu-item-title">View Student</span></div>
                                                            </a>
                                                        </li> -->
                                                        <li id="menu-item-424" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-424">
                                                            <a href="../includes/add_school.php">
                                                                <div class="menu-item-wrap"><span class="menu-item-title">Add School</span></div>
                                                            </a>
                                                        </li>
                                                        <!-- <li id="menu-item-424" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-424">
                                                            <a href="../includes/view_school.php">
                                                                <div class="menu-item-wrap"><span class="menu-item-title">View School</span></div>
                                                            </a>
                                                        </li> -->
                                                        <li id="menu-item-423" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-423">
                                                            <a href="../includes/add_college.php">
                                                        ...
                                                        <li id="menu-item-422" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-422">
                                                            <a href="../includes/college.php">
                                                                <div class="menu-item-wrap"><span class="menu-item-title">Register College</span></div>
                                                            </a>
                                                        </li>
                                                        <li id="menu-item-421" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-421">
                                                            <a href="../includes/contact_us.php">
                                                ...
                                                <li id="menu-item-1652" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1652 level-1">
                                                    <a href="../includes/all_school.php">
                                    ...
                                    <div class="header-right">
                                        <div id="header-right-inner" class="header-right-inner">
                                            ...
                                            <a href="./login.php" class="header-icon header-login-link">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <ul class="insight_core_breadcrumb">
                                            ...
                                            <li class="level-2 sub tail current"><span>Register your University</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="learnpress">
                                    ...
                                    <div class="learn-press-form-wrap learn-press-form-register-wrap col-md-6 col-md-push-3">
                                        ...
                                        <div class="learn-press-form-register learn-press-form">
                                            ...
                                            <h3 style="text-align: center;">Register your University</h3>
                                            ...
                                            <form name="learn-press-register" method="post" action="#">
                                                <ul class="form-fields">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input id="reg_email" name="reg_email" type="text" placeholder="Enter University Name : " autocomplete="email" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_email">Email address&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_email" name="reg_email" type="email" placeholder="Enter University Email : " autocomplete="email" value="">
                                                    </li>
                                                    <li class="form-field">
                                                        <label for="reg_username">Number&nbsp;<span class="required">*</span></label>
                                                        <input id="reg_username" name="reg_username" type="number" placeholder="Enter Registered Number : " autocomplete="number" value="">
                                                    </li>
                                                    <li class="form-field">
                                                    ...
                                                    <li class="form-field">
                                                        ...
                                                        <input id="reg_username" name="reg_username" type="text" placeholder="Enter Registered Address : " autocomplete="address" value="">
                                                    </li>
                                                    <li class="form-field">
