										...
										<nav id="menu" class="menu menu--primary">
											<ul id="menu-primary" class="menu__container sm sm-simple">
												...
												<li id="menu-item-20" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-20 level-1">
													...
													<ul class="sub-menu children simple-menu">
														...
														<li id="menu-item-426" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-426">
															<a href="<?= urlOf('assets/includes/university.php') ?>">
														...
														<li id="menu-item-1818"
															...
															<a href="../events/index.html">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Events</span></div>
															</a>
														</li>
														<li id="menu-item-3339"
															class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3339">
															<a href="../zoom-meetings/index.html">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Zoom Meetings</span>
																</div>
												...
												<li id="menu-item-1652" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1652 level-1">
													<a href="<?= urlOf('assets/includes/all_school.php') ?>">
												...
												<li id="menu-item-1652" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1652 level-1">
													...
													<!-- <ul class="sub-menu children simple-menu">
														<li id="menu-item-860"
															...
															<a href="../blog-grid/index.html">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Blog Grid</span></div>
															</a>
														</li>
														<li id="menu-item-859"
															class="menu-item menu-item-type-post_type menu-item-object-page menu-item-859">
															<a href="../blog-masonry/index.html">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Blog Masonry</span>
																</div>
															</a>
														</li>
														<li id="menu-item-858"
															...
															<a href="../blog-classic/index.html">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Blog Classic</span>
																</div>
															</a>
														</li>
														<li id="menu-item-857"
															...
															<a href="../blog-list/index.html">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Blog List</span></div>
															</a>
														</li>
													</ul> -->
												</li>
												<!-- <li id="menu-item-1817"
													class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1817 level-1">
													...
													<ul class="sub-menu children simple-menu">
														<li id="menu-item-1825"
															class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1825">
															<a
																href="../shop/indexf43d.html?shop_archive_preset=left-sidebar">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Shop Left Sidebar</span>
																</div>
															</a>
														</li>
														<li id="menu-item-1826"
															class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1826">
															<a
																href="../shop/index4527.html?shop_archive_preset=right-sidebar">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Shop Right
																		Sidebar</span></div>
															</a>
														</li>
														...
														<li id="menu-item-1823"
															class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1823">
															<a href="../wishlist/index.html">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Wishlist</span></div>
															</a>
														</li>
														<li id="menu-item-1820"
															class="menu-item menu-item-type-post_type menu-item-object-product menu-item-1820">
															<a href="../shop/use-seo-to-boost-your-business/index.html">
																<div class="menu-item-wrap"><span
																		class="menu-item-title">Single Product</span>
																</div>
															</a>
														</li>
													</ul>
									...
									<div class="header-right">
										<div id="header-right-inner" class="header-right-inner">
											...
											<!-- <div id="mini-cart" class="mini-cart">
												<a href="../cart/index.html" class="mini-cart__button header-icon"
													title="View your shopping cart"><span class="mini-cart-icon"
														data-count="0"></span></a>
